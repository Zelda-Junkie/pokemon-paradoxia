...
const struct RegionMapLocation gRegionMapEntries[] = {
    [MAPSEC_LITTLEROOT_TOWN] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("BRAMBLEWOOD TOWN"),
    },
    [MAPSEC_OLDALE_TOWN] = {
        .x = 4,
        .y = 9,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("PEBBLE CREEK"),
    },
    [MAPSEC_DEWFORD_TOWN] = {
        .x = 2,
        .y = 14,
    ...
    [MAPSEC_ROUTE_101] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("ROUTE 1000"),
    },
    [MAPSEC_ROUTE_102] = {
        .x = 2,
        .y = 9,
    ...
    [MAPSEC_ROUTE_109] = {
        ...
        .width = 1,
        .height = 3,
        .name = COMPOUND_STRING("BRAMBLEWOOD DOCK"),
    },
    [MAPSEC_ROUTE_110] = {
        .x = 8,
        .y = 7,
    ...
    [MAPSEC_TANOBY_RUINS] = {
        ...
        .width = 7,
        .height = 1,
        .name = COMPOUND_STRING("Pebble Maniac's House"),
    },
    ...
    [MAPSEC_ALTERING_CAVE] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("BRAMBLEWOOD LAB"),
    },
    [MAPSEC_NAVEL_ROCK] = {
        .x = 0,
        .y = 0,
