...
static const u32 sMugshotImg_Placeholder[] = INCBIN_U32("graphics/mugshots/placeholder.4bpp.lz");
static const u16 sMugshotPal_Placeholder[] = INCBIN_U16("graphics/mugshots/placeholder.gbapal");

static const struct Mugshot sMugshots[] = {
    [MUGSHOT_PLACEHOLDER] = {.x = 0, .y = 0, .width = 8, .height = 8, .image = sMugshotImg_Placeholder, .palette = sMugshotPal_Placeholder},
};
